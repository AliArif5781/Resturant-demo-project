...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const role = await signup(formData.email, formData.password, formData.displayName, "user");
      toast({
        title: "Success",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-orange-900">
      {/* Header */}
      <header className="border-b border-slate-700 sticky top-0 bg-slate-900/80 backdrop-blur-md z-50" data-testid="header-signup">
